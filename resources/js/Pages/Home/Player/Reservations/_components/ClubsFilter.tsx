                        ...
                        <div className="grid gap-4">
                            <div className="grid gap-2">
                                <div className="grid grid-cols-2 items-center py-2 gap-4">
                                    <Label htmlFor="status">Distância</Label>
                                    <div className="flex items-center space-x-2">
                                        <Switch id="status" />
                                        <Label htmlFor="status">
                                            {isCovered ? "Ativo" : "Inativo"}
                                        </Label>
                                    </div>
                                </div>
                                <div className="grid grid-cols-2 items-center gap-4">
                                    <Label htmlFor="maxWidth">Esporte</Label>
                                    <Select
                                        value={sport}
                                ...
                                <div className="grid grid-cols-2 items-center gap-4 border p-2 rounded">
                                    <Label htmlFor="time">Funcionamento</Label>
                                ...
                                <div className="grid grid-cols-2 items-center gap-4">
                                    <Label htmlFor="time">Preço Médio</Label>
                                    <div className="grid grid-cols-2 gap-2 w-full">
                                        <Input
                                            type="number"
                                            className="w-full"
